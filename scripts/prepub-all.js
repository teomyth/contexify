...
runCommand('pnpm prepub', 'Main package validation (clean, fix, build, test)');
...
runCommand('FORCE_COLOR=true pnpm turbo run docs:check --filter=docs-code | FORCE_COLOR=true grep --color=always -v "contexify:build:"', 'Documentation code syntax check');
