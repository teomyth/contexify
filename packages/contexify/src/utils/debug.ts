...
/**
 * Creates a debugger function with the specified namespace
 * @param namespace - The namespace for the debugger
 * @returns A debugger function
 */
// Make sure to parse environment variables before creating debuggers
function ensureEnvParsed() {
  parseDebugEnv();
}

export function createDebugger(namespace: string): Debugger {
  // Parse environment variables when creating a debugger
  ensureEnvParsed();
 ...
 */
export function configure(options: DebuggerOptions) {
